...
<qgis version="3.30.3-'s-Hertogenbosch">
  <identifier>GEO_EJES2010</identifier>
  <parentidentifier></parentidentifier>
  <language>ES</language>
  <type>dataset</type>
  <title>GEO_EJES2010</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="File Geodatabase Feature Class" type="Local Area Network" mimeType="" size="" url="file://\\AMEZA\D$\TRABAJOS REALIZADOS\GEODATABASE\GEODATABASE_EMPATADA\GEODATABASE.gdb" format="" description=""/>
  </links>
  <dates/>
  <fees></fees>
