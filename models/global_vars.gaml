...
global {
	...
	int n_cars;
	int n_motorbikes;
	int n_hibridos; //número de hibridos para la simulacion
	int road_scenario;
	int display_mode;
	// Save params' old values to detect value changes
	int n_cars_prev;
	int n_motorbikes_prev;
	int n_hibridos_prev; //numero de hibridos previstos
	...
	int max_number_of_hibridos <- 500 const:true;
	...
	map<string,rgb> palet <- [
		...
		CAR:: #orange,
		MOTOBYKE:: #cyan,
		HIBRIDO:: #purple, //color morado para los vehiculos hibridos
